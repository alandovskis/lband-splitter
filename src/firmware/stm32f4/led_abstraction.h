...
typedef struct {
    ...
    bool (*set_rgb_color)(struct LedAbstraction* led, uint8_t r, uint8_t g, uint8_t b);
...
LedAbstraction* led_create(uint8_t led_id, uint8_t port_id, LedType type, LedColor color);
