...
private:
    ...
    int handle_get_config_request(struct nc_session* session, const struct nc_rpc* rpc);
    int handle_edit_config_request(struct nc_session* session, const struct nc_rpc* rpc);
    int handle_commit_request(struct nc_session* session);
    int handle_copy_config_request(struct nc_session* session, const struct nc_rpc* rpc);
