...
public:
  explicit WebSocketServer(core::SplitterManager *splitter_manager,
                           int port = 8081);
  ~WebSocketServer();
...
private:
  ...
  web::json::value create_frequency_change_message(int port_id,
  ...
  std::unique_ptr<web::websockets::experimental::listener::websocket_listener>
      ws_listener_;
