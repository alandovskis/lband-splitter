...
bool Logger::init(const std::string &log_file_path,
                  const std::string &log_level, size_t max_file_size_mb,
                  size_t max_files) {
  ...
  try {
    ...
    logger_ = std::make_shared<spdlog::logger>(
        "splitter_daemon", spdlog::sinks_init_list{console_sink, file_sink});
...
bool Logger::is_initialized() { return logger_ != nullptr; }
