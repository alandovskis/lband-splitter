...
public:
    using StateChangeCallback = std::function<void(int port_id, const PortState& state)>;
    using FrequencyChangeCallback = std::function<void(int port_id, double frequency_mhz)>;
