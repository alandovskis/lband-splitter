...
public:
  MockableGpioController() {
    ...
    ON_CALL(*this, configure_input_pin(::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, configure_output_pin(::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, set_pin_high(::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, set_pin_low(::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, set_pin_state(::testing::_, ::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, get_pin_state(::testing::_))
        .WillByDefault(::testing::Return(hardware::PinState::LOW));
    ON_CALL(*this, is_pin_configured(::testing::_))
        .WillByDefault(::testing::Return(true));
    ON_CALL(*this, is_pin_healthy(::testing::_))
        .WillByDefault(::testing::Return(true));
