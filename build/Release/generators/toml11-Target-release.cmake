...
conan_package_library_targets("${toml11_LIBS_RELEASE}"    # libraries
                              ...
                              "${toml11_BIN_DIRS_RELEASE}" # package_bindir
                              "${toml11_LIBRARY_TYPE_RELEASE}"
                              "${toml11_IS_HOST_WINDOWS_RELEASE}"
                              toml11_DEPS_TARGET
                              toml11_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "toml11"    # package_name
                              "${toml11_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET toml11::toml11
                 ...
                 $<$<CONFIG:Release>:${toml11_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET toml11::toml11
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${toml11_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET toml11::toml11
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${toml11_LIB_DIRS_RELEASE}>)
    set_property(TARGET toml11::toml11
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${toml11_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET toml11::toml11
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${toml11_COMPILE_OPTIONS_RELEASE}>)
